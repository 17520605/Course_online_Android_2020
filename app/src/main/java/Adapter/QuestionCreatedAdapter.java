...
public class QuestionCreatedAdapter extends RecyclerView.Adapter<QuestionCreatedAdapter.ViewHolder> {
    private List<MutipleChoiceModel> data;
    private String courseId;
    private String lessonId;

    public QuestionCreatedAdapter(List<MutipleChoiceModel> data, String courseId, String lessonId){
        this.data = data;
    ...
    @Override
    public QuestionCreatedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.item_test_created, parent, false);
        QuestionCreatedAdapter.ViewHolder viewHolder = new QuestionCreatedAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(QuestionCreatedAdapter.ViewHolder holder, int position) {
